...
import { EnhancedTableHead, EnhancedTableToolbar } from '../Components/EnhancedTableHead/EnhancedTableHead';
    ...
    <ThemeProvider theme={theme}>
      <Box>
        <TableContainer component={Paper} sx={{ margin: 4 }} size={dense ? 'small' : 'medium'}>
          <EnhancedTableToolbar numSelected={selected.length} type="users" name="Пользователи" selectedArray={selected} />
